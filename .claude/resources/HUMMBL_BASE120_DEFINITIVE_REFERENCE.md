# HUMMBL Base120 - DEFINITIVE REFERENCE
**Version**: 1.0-beta
**Source**: Google Drive (Created 10/16/2025)
**Purpose**: Authoritative list for LLM/agent coordination
...
**Total Models**: 120
**Structure**: 6 Transformations × 20 Models Each
**Coding**: [TRANSFORMATION_CODE][MODEL_NUMBER] (e.g., P1, IN15, CO7)
...
| Code | Model Name | One-Line Definition |
|------|-----------|---------------------|
...
### For LLMs/Agents:
1. **NEVER substitute generic mental models** (OODA Loop, Hanlon's Razor, etc.)
2. **ALWAYS reference by code** (e.g., "P1", "IN15", "CO7")
3. **Verify against this list** before claiming a model number
4. **If uncertain**, query this reference document

### For Developers:
1. **Inject this reference** into agent context windows
2. **Validate model codes** programmatically against this list
3. **Log any deviations** for review
4. **Update systems** to use these exact names

### Common Errors to Avoid:
- ❌ P1 = "Mental Model" (too generic)
- ❌ P7 = "OODA Loop" (not in Base120)
- ❌ P17 = "Hanlon's Razor" (not in Base120)
- ❌ IN = "Inversion" without model number (incomplete reference)

### Correct Usage Examples:
- ✅ "Applying P1 (First Principles Framing) to..."
- ✅ "Using DE3 (Modularization) and CO8 (Layered Abstraction)..."
- ✅ "This requires IN2 (Premortem Analysis) before proceeding"

---

## VALIDATION CHECKLIST

Before using any mental model reference:
- [ ] Code matches pattern: [P|IN|CO|DE|RE|SY][1-20]
- [ ] Name matches exactly as listed above
- [ ] Model is in correct transformation category
...
|---------|------|---------|--------|
| 1.0-beta | 2025-10-16 | Initial Base120 framework | Reuben Bowlby |
| 1.0-ref | 2025-11-12 | Definitive reference for agent coordination | Claude (authorized) |

---

## SOURCE DOCUMENT
**Original**: [Google Drive Document](https://docs.google.com/document/d/1yZd1CxU1ZzJjv-MBoxyc3VOD_0-IOfVK8LHL_5qr2EM/edit)
**Created**: October 16, 2025
**Owner**: Reuben Bowlby <rpbowlby@gmail.com>

---

**END OF DEFINITIVE REFERENCE**
